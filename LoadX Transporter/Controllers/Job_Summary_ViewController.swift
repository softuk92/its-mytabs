...
//          if jsonData_inventory["Triple_Wardrobe"].stringValue != "0" && jsonData_inventory["Triple_Wardrobe"].stringValue != " " && jsonData_inventory["Triple_Wardrobe"].stringValue != "" {
...
//          }
//          if jsonData_inventory["Single_Wardrobe"].stringValue != "0" && jsonData_inventory["Single_Wardrobe"].stringValue != " " && jsonData_inventory["Single_Wardrobe"].stringValue != "" {
...
//          }
//
//          if jsonData_inventory["Single_Bed"].stringValue != "0" && jsonData_inventory["Single_Bed"].stringValue != " " && jsonData_inventory["Single_Bed"].stringValue != "" {
...
//                 }
//          if jsonData_inventory["Television"].stringValue != "0" && jsonData_inventory["Television"].stringValue != " " && jsonData_inventory["Television"].stringValue != "" {
...
//                 }
//          if jsonData_inventory["Three_Seater_Sofa"].stringValue != "0" && jsonData_inventory["Three_Seater_Sofa"].stringValue != " " && jsonData_inventory["Three_Seater_Sofa"].stringValue != "" {
...
//                 }
//          if jsonData_inventory["Small_Box"].stringValue != "0" && jsonData_inventory["Small_Box"].stringValue != " " && jsonData_inventory["Small_Box"].stringValue != "" {
...
//                 }
//          if jsonData_inventory["Dining_Chairs"].stringValue != "0" && jsonData_inventory["Dining_Chairs"].stringValue != " " && jsonData_inventory["Dining_Chairs"].stringValue != ""  {
...
//                 }
//          if jsonData_inventory["Fridge_And_Freezer"].stringValue != "0" && jsonData_inventory["Fridge_And_Freezer"].stringValue != " " && jsonData_inventory["Fridge_And_Freezer"].stringValue != "" {
...
//                 }
//
//          if jsonData_inventory["Bench"].stringValue != "0" && jsonData_inventory["Bench"].stringValue != " " && jsonData_inventory["Bench"].stringValue != "" {
...
//                 }
//          if jsonData_inventory["Bookcase"].stringValue != "0" && jsonData_inventory["Bookcase"].stringValue != " " && jsonData_inventory["Bookcase"].stringValue != "" {
...
//                 }
//          if jsonData_inventory["Queensize_Bed"].stringValue != "0" && jsonData_inventory["Queensize_Bed"].stringValue != " " && jsonData_inventory["Queensize_Bed"].stringValue != "" {
...
//                 }
//          if jsonData_inventory["Bags"].stringValue != "0" && jsonData_inventory["Bags"].stringValue != " " && jsonData_inventory["Bags"].stringValue != "" {
...
//                 }
//          if jsonData_inventory["Four_Seater_Table_And_Chairs"].stringValue != "0" && jsonData_inventory["Four_Seater_Table_And_Chairs"].stringValue != " " && jsonData_inventory["Four_Seater_Table_And_Chairs"].stringValue != "" {
...
//                 }
//          if jsonData_inventory["Office_Chairs"].stringValue != "0" && jsonData_inventory["Office_Chairs"].stringValue != " " && jsonData_inventory["Office_Chairs"].stringValue != "" {
...
//                 }
//
//              if jsonData_inventory["2_Seater_Sofa"].stringValue != "0" && jsonData_inventory["2_Seater_Sofa"].stringValue != " " && jsonData_inventory["2_Seater_Sofa"].stringValue != "" {
...
//                }
//                if jsonData_inventory["Two_Seater_Sofa"].stringValue != "0" && jsonData_inventory["Two_Seater_Sofa"].stringValue != " " && jsonData_inventory["Two_Seater_Sofa"].stringValue != "" {
...
//                }
//
//                if jsonData_inventory["Double_Mattress"].stringValue != "0" && jsonData_inventory["Double_Mattress"].stringValue != " " && jsonData_inventory["Double_Mattress"].stringValue != "" {
...
//                       }
//                if jsonData_inventory["Suitcases"].stringValue != "0" && jsonData_inventory["Suitcases"].stringValue != " " && jsonData_inventory["Suitcases"].stringValue != "" {
...
//                       }
//                if jsonData_inventory["Microwave"].stringValue != "0" && jsonData_inventory["Microwave"].stringValue != " " && jsonData_inventory["Microwave"].stringValue != "" {
...
//                       }
//                if jsonData_inventory["Rug"].stringValue != "0" && jsonData_inventory["Rug"].stringValue != " " && jsonData_inventory["Rug"].stringValue != "" {
...
//                       }
//                if jsonData_inventory["Four_Seater_Sofa"].stringValue != "0" && jsonData_inventory["Four_Seater_Sofa"].stringValue != " " && jsonData_inventory["Four_Seater_Sofa"].stringValue != "" {
...
//                       }
//                if jsonData_inventory["Curtain_Hanger"].stringValue != "0" && jsonData_inventory["Curtain_Hanger"].stringValue != " " && jsonData_inventory["Curtain_Hanger"].stringValue != "" {
...
//
//
//                if jsonData_inventory["TV_Stand"].stringValue != "0" && jsonData_inventory["TV_Stand"].stringValue != " " && jsonData_inventory["TV_Stand"].stringValue != "" {
...
//                       }
//                if jsonData_inventory["Dishwasher"].stringValue != "0" && jsonData_inventory["Dishwasher"].stringValue != " " && jsonData_inventory["Dishwasher"].stringValue != ""{
...
//                       }
//                if jsonData_inventory["Mirror"].stringValue != "0" && jsonData_inventory["Mirror"].stringValue != " " && jsonData_inventory["Mirror"].stringValue != "" {
...
//                       }
//                if jsonData_inventory["Bathroom_Cabinet"].stringValue != "0" && jsonData_inventory["Bathroom_Cabinet"].stringValue != " " && jsonData_inventory["Bathroom_Cabinet"].stringValue != "" {
...
//                       }
//                if jsonData_inventory["Washing_Machine"].stringValue != "0" && jsonData_inventory["Washing_Machine"].stringValue != " " && jsonData_inventory["Washing_Machine"].stringValue != "" {
...
//                       }
//
//              if jsonData_inventory["Office_Table"].stringValue != "0" && jsonData_inventory["Office_Table"].stringValue != " " && jsonData_inventory["Office_Table"].stringValue != ""  {
...
//                         }
//              if jsonData_inventory["Dryer"].stringValue != "0" && jsonData_inventory["Dryer"].stringValue != " " && jsonData_inventory["Dryer"].stringValue != ""{
...
//                         }
//
//              if jsonData_inventory["Kitchen_Chairs"].stringValue != "0" && jsonData_inventory["Kitchen_Chairs"].stringValue != " " && jsonData_inventory["Kitchen_Chairs"].stringValue != "" {
...
//                                }
//                         if jsonData_inventory["Garden_Table"].stringValue != "0" && jsonData_inventory["Garden_Table"].stringValue != " " && jsonData_inventory["Garden_Table"].stringValue != "" {
...
//                                }
//
//                         if jsonData_inventory["Kitchen_Table"].stringValue != "0" && jsonData_inventory["Kitchen_Table"].stringValue != " " && jsonData_inventory["Kitchen_Table"].stringValue != "" {
...
//                                }
//                         if jsonData_inventory["Coffee_Table"].stringValue != "0" && jsonData_inventory["Coffee_Table"].stringValue != " " && jsonData_inventory["Coffee_Table"].stringValue != "" {
...
//                                }
//                         if jsonData_inventory["Freezer"].stringValue != "0" && jsonData_inventory["Freezer"].stringValue != " " && jsonData_inventory["Freezer"].stringValue != "" {
...
//                                }
//
//                         if jsonData_inventory["Bedside_Table"].stringValue != "0" && jsonData_inventory["Bedside_Table"].stringValue != " " && jsonData_inventory["Bedside_Table"].stringValue != "" {
...
//                                }
//                         if jsonData_inventory["Cooker"].stringValue != "0" && jsonData_inventory["Cooker"].stringValue != " " && jsonData_inventory["Cooker"].stringValue != "" {
...
//                                }
//                         if jsonData_inventory["Display_Cabinet"].stringValue != "0" && jsonData_inventory["Display_Cabinet"].stringValue != " " && jsonData_inventory["Display_Cabinet"].stringValue != "" {
...
//                                }
//                         if jsonData_inventory["Chest_of_Drawers"].stringValue != "0" && jsonData_inventory["Chest_of_Drawers"].stringValue != " " && jsonData_inventory["Chest_of_Drawers"].stringValue != "" {
...
//                                }
//                         if jsonData_inventory["Kingsize_Bed"].stringValue != "0" && jsonData_inventory["Kingsize_Bed"].stringValue != " " && jsonData_inventory["Kingsize_Bed"].stringValue != ""  {
...
//                                }
//                         if jsonData_inventory["Six_Seater_Table_And_Chairs"].stringValue != "0" && jsonData_inventory["Six_Seater_Table_And_Chairs"].stringValue != " " && jsonData_inventory["Six_Seater_Table_And_Chairs"].stringValue != "" {
...
//                                }
//
//          if jsonData_inventory["Dressing_Table"].stringValue != "0" && jsonData_inventory["Dressing_Table"].stringValue != " " && jsonData_inventory["Dressing_Table"].stringValue != "" {
...
//                     }
//                     if jsonData_inventory["Shelf"].stringValue != "0" && jsonData_inventory["Shelf"].stringValue != " " && jsonData_inventory["Shelf"].stringValue != "" {
...
//                     }
//
//                     if jsonData_inventory["3_Seater_Sofa"].stringValue != "0" && jsonData_inventory["3_Seater_Sofa"].stringValue != " " && jsonData_inventory["3_Seater_Sofa"].stringValue != "" {
...
//                            }
//                     if jsonData_inventory["Double_Wardrobe"].stringValue != "0" && jsonData_inventory["Double_Wardrobe"].stringValue != " " && jsonData_inventory["Double_Wardrobe"].stringValue != "" {
...
//                            }
//                      if jsonData_inventory["Double_Bed"].stringValue != "0" && jsonData_inventory["Double_Bed"].stringValue != " " && jsonData_inventory["Double_Bed"].stringValue != "" {
...
//                            }
//                     if jsonData_inventory["Medium_Box"].stringValue != "0" && jsonData_inventory["Medium_Box"].stringValue != " " && jsonData_inventory["Medium_Box"].stringValue != "" {
...
//                            }
//                     if jsonData_inventory["Garden_Chairs"].stringValue != "0" && jsonData_inventory["Garden_Chairs"].stringValue != " " && jsonData_inventory["Garden_Chairs"].stringValue != "" {
...
//                            }
//
//                     if jsonData_inventory["Fridge"].stringValue != "0" && jsonData_inventory["Fridge"].stringValue != " " && jsonData_inventory["Fridge"].stringValue != "" {
...
//                            }
//                     if jsonData_inventory["Large_Box"].stringValue != "0" && jsonData_inventory["Large_Box"].stringValue != " " && jsonData_inventory["Large_Box"].stringValue != "" {
...
//                            }
//                     if jsonData_inventory["Arm_Chair"].stringValue != "0" && jsonData_inventory["Arm_Chair"].stringValue != " " && jsonData_inventory["Arm_Chair"].stringValue != "" {
...
//              }
//            if jsonData_inventory["umaruu"].stringValue != "0" && jsonData_inventory["umaruu"].stringValue != " " && jsonData_inventory["umaruu"].stringValue != "" {
//                              print("print it %@",jsonData_inventory["umaruu"].stringValue)
//                              items.append(MenuItemStruct(title: "Umaruu", value: jsonData_inventory["umaruu"].stringValue))
//            }
//            if jsonData_inventory["test_sa"].stringValue != "0" && jsonData_inventory["test_sa"].stringValue != " " && jsonData_inventory["test_sa"].stringValue != "" {
//                              print("print it %@",jsonData_inventory["test_sa"].stringValue)
//                              items.append(MenuItemStruct(title: "Test_sa", value: jsonData_inventory["test_sa"].stringValue))
//            }
//            if jsonData_inventory["test"].stringValue != "0" && jsonData_inventory["test"].stringValue != " " && jsonData_inventory["test"].stringValue != "" {
//                              print("print it %@",jsonData_inventory["test"].stringValue)
//                              items.append(MenuItemStruct(title: "Test", value: jsonData_inventory["test"].stringValue))
//            }
//        }else{
